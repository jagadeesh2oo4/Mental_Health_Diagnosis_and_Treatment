...
def main():
    ...
    model = DeepAnn(input_size=input_size, num_classes=num_classes)  # replace with other
    ...
    torch.save(trained_model.state_dict(), "deep_ann_model.pth")
    print("Model saved as 'deep_ann_model.pth'.")
...
if __name__ == "__main__":
    ...
    #
    #     # get the first batch of test images and lables
    #     images, lables = next(iter(val_loader))
    #     images, lables = images[:2].to(device), lables[:2].to(device)
    #
